...
namespace Flatify
{
    public partial class FlatThemeProvider
    {
        ...
        private void GenerateThemeLayout(StringBuilder theme)
        {
            ...
            // theme.AppendLine($"--flat-simple-transition: 0.15s ease-in-out !default;");
            // theme.AppendLine($"--flat-long-transition: 1s ease-in-out !default;");
            // theme.AppendLine($"--flat-bouncing-transition: 0.35s cubic-bezier(0.59, -0.39, 0.36, 1.38) !default;");
        }
